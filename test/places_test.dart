...
Future<void> main() async {
  ...
  group('Google Maps Places', () {
    ...
    test('decode search response', () {
      ...
      expect(response.results.first.icon, equals('http://maps.gstatic.com/mapfiles/place_api/icons/travel_agent-71.png'));
      expect(response.results.first.id, equals('21a0b251c9b8392186142c798263e289fe45b4aa'));
      ...
      expect(response.results.first.photos.first.photoReference, equals('CnRnAAAAF-LjFR1ZV93eawe1cU_3QNMCNmaGkowY7CnOf-kcNmPhNnPEG9W979jOuJJ1sGr75rhD5hqKzjD8vbMbSsRnq_Ni3ZIGfY6hKWmsOf3qHKJInkm4h55lzvLAXJVc-Rr4kI9O1tmIblblUpg2oqoq8RIQRMQJhFsTr5s9haxQ07EQHxoUO0ICubVFGYfJiMUPor1GnIWb5i8'));
      expect(response.results.first.placeId, equals('ChIJyWEHuEmuEmsRm9hTkapTCrk'));
      expect(response.results.first.scope, equals('GOOGLE'));
      expect(response.results.first.altIds, hasLength(equals(1)));
      expect(response.results.first.altIds.first.placeId, equals('D9iJyWEHuEmuEmsRm9hTkapTCrk'));
      expect(response.results.first.altIds.first.scope, equals('APP'));
      expect(response.results.first.reference, equals('CoQBdQAAAFSiijw5-cAV68xdf2O18pKIZ0seJh03u9h9wk_lEdG-cP1dWvp_QGS4SNCBMk_fB06YRsfMrNkINtPez22p5lRIlj5ty_HmcNwcl6GZXbD2RdXsVfLYlQwnZQcnu7ihkjZp_2gk1-fWXql3GQ8-1BEGwgCxG-eaSnIJIBPuIpihEhAY1WYdxPvOWsPnb2-nGb6QGhTipN0lgaLpQTnkcMeAIEvCsSa0Ww'));
      expect(response.results.first.types, equals(['travel_agency', 'restaurant', 'food', 'establishment']));
      expect(response.results.first.vicinity, equals('Pyrmont Bay Wharf Darling Dr, Sydney'));
    });

    test('decode autocomplete response', () {
      final response = PlacesAutocompleteResponse.fromJson(_autocompleteResponseExample);
      ...
      expect(p1.matchedSubstrings.first, MatchedSubstring(offset: 0, length: 5));
      expect(p1.placeId, 'ChIJD7fiBh9u5kcRYJSMaMOCCwQ');
      expect(p1.reference, 'CjQlAAAA_KB6EEceSTfkteSSF6U0pvumHCoLUboRcDlAH05N1pZJLmOQbYmboEi0SwXBSoI2EhAhj249tFDCVh4R-PXZkPK8GhTBmp_6_lWljaf1joVs1SH2ttB_tw');
      expect(p1.terms, [Term(offset: 0, value: 'Paris'), Term(offset: 7, value: 'France')]);
  ...
  group('Place Search Response', () {
    test('decode text search response', () {
      ...
      expect(response.results.first.geometry?.location.lat, equals(-37.8136276));
      expect(response.results.first.geometry?.location.lng, equals(144.9630576));
      expect(response.results.first.icon, equals('https://maps.gstatic.com/mapfiles/place_api/icons/v1/png_71/geocode-71.png'));
      ...
      expect(response.results.first.photos.first.photoReference, equals('ATtYBwK5nQr4pKVwk0xnAaIV2hj-I4710I5sdXh7eGGBQWFrOD1N7AJgXy7ZnHwsE0Lbk9yNlj42REQM8ZWKm-7HIDj1mrNXEh6lWoNPc9JVywROmrHVCqnOuER3bmbrGQR7JRsF3n2uBilksqdJoSNuvr8BH4S4KJpyD_CiIUhed1JAvoEo'));
      expect(response.results.first.placeId, equals('ChIJ90260rVG1moRkM2MIXVWBAQ'));
      expect(response.results.first.scope, isNull);
      expect(response.results.first.altIds, isEmpty);
      expect(response.results.first.reference, equals('ChIJ90260rVG1moRkM2MIXVWBAQ'));
      expect(response.results.first.types, equals(['colloquial_area', 'locality', 'political']));
  ...
  group('Place details response', () {
    test('decode place details with null review language', () {
      ...
      expect(details.formattedAddress, equals('Filigudi Ct, Frankston South VIC 3199, Australia'));
      expect(details.formattedPhoneNumber, equals('0431 887 848'));
      expect(details.icon, equals('https://maps.gstatic.com/mapfiles/place_api/icons/v1/png_71/school-71.png'));
  ...
  'results': [
    {
      ...
      'photos': [
        {'height': 270, 'html_attributions': [], 'photo_reference': 'CnRnAAAAF-LjFR1ZV93eawe1cU_3QNMCNmaGkowY7CnOf-kcNmPhNnPEG9W979jOuJJ1sGr75rhD5hqKzjD8vbMbSsRnq_Ni3ZIGfY6hKWmsOf3qHKJInkm4h55lzvLAXJVc-Rr4kI9O1tmIblblUpg2oqoq8RIQRMQJhFsTr5s9haxQ07EQHxoUO0ICubVFGYfJiMUPor1GnIWb5i8', 'width': 519}
      ],
    ...
    },
    {
      ...
      'photos': [
        {'height': 426, 'html_attributions': [], 'photo_reference': 'CnRnAAAAL3n0Zu3U6fseyPl8URGKD49aGB2Wka7CKDZfamoGX2ZTLMBYgTUshjr-MXc0_O2BbvlUAZWtQTBHUVZ-5Sxb1-P-VX2Fx0sZF87q-9vUt19VDwQQmAX_mjQe7UWmU5lJGCOXSgxp2fu1b5VR_PF31RIQTKZLfqm8TA1eynnN4M1XShoU8adzJCcOWK0er14h8SqOIDZctvU', 'width': 640}
      ],
    ...
    },
    {
      ...
      'opening_hours': {'open_now': true},
      'photos': [
        {'height': 600, 'html_attributions': [], 'photo_reference': 'CnRnAAAA48AX5MsHIMiuipON_Lgh97hPiYDFkxx_vnaZQMOcvcQwYN92o33t5RwjRpOue5R47AjfMltntoz71hto40zqo7vFyxhDuuqhAChKGRQ5mdO5jv5CKWlzi182PICiOb37PiBtiFt7lSLe1SedoyrD-xIQD8xqSOaejWejYHCN4Ye2XBoUT3q2IXJQpMkmffJiBNftv8QSwF4', 'width': 800}
      ],
    ...
    },
    {
      ...
      'opening_hours': {'open_now': true},
      'photos': [
        {'height': 242, 'html_attributions': [], 'photo_reference': 'CnRnAAAABjeoPQ7NUU3pDitV4Vs0BgP1FLhf_iCgStUZUr4ZuNqQnc5k43jbvjKC2hTGM8SrmdJYyOyxRO3D2yutoJwVC4Vp_dzckkjG35L6LfMm5sjrOr6uyOtr2PNCp1xQylx6vhdcpW8yZjBZCvVsjNajLBIQ-z4ttAMIc8EjEZV7LsoFgRoU6OrqxvKCnkJGb9F16W57iIV4LuM', 'width': 200}
      ],
...
const _textSearchResponseExample = {
  'html_attributions': [],
  'next_page_token': 'HLx6WLSSOdkvf0uHaIppbWYqZzx5cSuZa0xMp6nuaCxm7tdUuZa6JT898vAerxj8wRkMIlsYGEjQ9m0d6rQ',
  'results': [
    {
      ...
      'photos': [
        {
          'height': 810,
          'html_attributions': ['\u003ca href=\"https://maps.google.com/maps/contrib/107196947767897770095\"\u003eUwe Delau\u003c/a\u003e'],
          'photo_reference': 'ATtYBwK5nQr4pKVwk0xnAaIV2hj-I4710I5sdXh7eGGBQWFrOD1N7AJgXy7ZnHwsE0Lbk9yNlj42REQM8ZWKm-7HIDj1mrNXEh6lWoNPc9JVywROmrHVCqnOuER3bmbrGQR7JRsF3n2uBilksqdJoSNuvr8BH4S4KJpyD_CiIUhed1JAvoEo',
          'width': 1080
        }
      ],
...
const _placeDetailsExample = {
  ...
  'adr_address': '<span class=\"street-address\">Filigudi Ct</span>, <span class=\"locality\">Frankston South</span> <span class=\"region\">VIC</span> <span class=\"postal-code\">3199</span>, <span class=\"country-name\">Australia</span>',
  ...
  'photos': [
    {
      'height': 4032,
      'html_attributions': ['<a href=\"https://maps.google.com/maps/contrib/101246297873069804005\">Habitat Surf</a>'],
      'photo_reference': 'ATtYBwLH_-MyoefQNFeI_G3WoFTdjI-zTcK6-KhRS2qYdaHvvHPW-80408rIrTOCCV1SAiYNp40x-Ut7hBGrzP6PM0I4c0WrFPGybaF_ftyNOdAD2l7D6LhfXbgqfbv7hMXTZkP-bdEK24i2_SF5Y7tkHErPRzD3Z1EAfz4wKwQ1mmbxLCV1',
      'width': 2268
    },
    {
      'height': 3557,
      'html_attributions': ['<a href=\"https://maps.google.com/maps/contrib/101246297873069804005\">Habitat Surf</a>'],
      'photo_reference': 'ATtYBwJ9LhX8MhRj8lnJnlqmv-6uraUb_5_ozvQxuzRGRyTniZjo0_bzyh-Mi7SXvH9OSyqB8qwIk2EdnBOuHoU6tlsEGs7wCSNUFeWiI20AKGjrYgeu073sTvwVr_Of0Ka7258NKdf1qEdiQx2ZY8P4wcRb9TkyRjaEXZi2-aCGmLEulHke',
      'width': 3024
    },
    {
      'height': 1024,
      'html_attributions': ['<a href=\"https://maps.google.com/maps/contrib/101246297873069804005\">Habitat Surf</a>'],
      'photo_reference': 'ATtYBwIcWzamoiCsqsBSVTYlF4TujnnfK2C8sBSk0fwyrB-tw5D-6KKg7uuRL2l_Ndi-7RnrcYV9otV0l41pu5lEus2tkTyVxkyFWOj_cN-zJiOkyBSleC3II2ozocDsxXiEsWzUhxKiMJjYI1Bsi186kIbzsBMYjLoD64dgBoSfrBQVhG8h',
      'width': 1024
    },
    {
      'height': 2268,
      'html_attributions': ['<a href=\"https://maps.google.com/maps/contrib/101246297873069804005\">Habitat Surf</a>'],
      'photo_reference': 'ATtYBwJiDjV_qKQoxeTMie8lpIatwAGpjpx2oOB_0iQSO5Z87NP5OgPBncLA6ti--yYgXAll17RynG89FlQNSfm7_eua-Qbd7Fyu2-FxIecp60lqIgI9gt-SXSFMRrH_pYxj2SgXVpcIN5ObRFm6-E8V8hARy78dBBBuNAzLKegylJoypikp',
      'width': 4032
    },
    {
      'height': 2268,
      'html_attributions': ['<a href=\"https://maps.google.com/maps/contrib/101246297873069804005\">Habitat Surf</a>'],
      'photo_reference': 'ATtYBwI3Plt0GnRqnTpBil97Ggn7p4Da6-x6RP3My8Mldd0qJFK-gm0khac0VTe4bLIjkbq4dVeqYtnJq9__GQTGjGoO9s1iPI8bjmnwPUXUTRXf_gtU7AGrwPBUfqL5KsmCMq4SUtOWRKVCIZ1IwQclziSg9UCy3ZfJWazI--Be4IYV88PY',
      'width': 4032
    }
  ],
  'place_id': 'ChIJOaVBtTEL1moR5DB1DK8b_6k',
  'plus_code': {'compound_code': 'R47W+86 Frankston South VIC, Australia', 'global_code': '4RH7R47W+86'},
  'rating': 5,
  'reference': 'ChIJOaVBtTEL1moR5DB1DK8b_6k',
  'reviews': [
    {'author_name': 'Lara Simpkin', 'author_url': 'https://www.google.com/maps/contrib/117980375521320943840/reviews', 'language': 'en', 'profile_photo_url': 'https://lh6.googleusercontent.com/-AUyEguuteZ4/AAAAAAAAAAI/AAAAAAAAAAA/AMZuucm0aQ9YcgyecL1MOW2w3irNfj0fBQ/s128-c0x00000000-cc-rp-mo/photo.jpg', 'rating': 5, 'relative_time_description': '3 weeks ago', 'text': 'I nabbed one of these boards for our living room as a display. It perfectly compliments our modern coastal aesthetic - we always get compliments on it!', 'time': 1615440498},
    {'author_name': 'David Coyne', 'author_url': 'https://www.google.com/maps/contrib/112991978235168481824/reviews', 'profile_photo_url': 'https://lh6.googleusercontent.com/-We_CzC0y0Kg/AAAAAAAAAAI/AAAAAAAAAAA/AMZuuckQJRKvgC10HUkNiNzZ2TJRyu2W3A/s128-c0x00000000-cc-rp-mo/photo.jpg', 'rating': 5, 'relative_time_description': '3 weeks ago', 'text': '', 'time': 1615428580},
    {'author_name': 'Dave O', 'author_url': 'https://www.google.com/maps/contrib/115299138534899794552/reviews', 'profile_photo_url': 'https://lh3.googleusercontent.com/-vMsKOs0joL4/AAAAAAAAAAI/AAAAAAAAAAA/AMZuucndtNljtuj_7VlO7uH9vCXoXFVw5A/s128-c0x00000000-cc-rp-mo-ba2/photo.jpg', 'rating': 5, 'relative_time_description': '3 weeks ago', 'text': '', 'time': 1615427962}
  ],
